...
<html>
	...
	<body>
		<div id="wrap" class="text-center">
			...
			<div id="postBbsWrap">
				<c:url var = "bbsPost" value="bbsPostAction.do"></c:url>
				<form:form commandName="BbsVO" action="${bbsPost}">
					...
					<div class ="submit">
						<input id ="submit" type = "submit" value="글작성" class="btn btn-primary btn-lg">
					</div>
